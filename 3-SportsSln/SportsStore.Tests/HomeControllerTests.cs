...
namespace SportsStore.Tests {
    public class ProductControllerTests {
        ...
        public void Can_Filter_Products() {
            ...
            Mock<IStoreRepository> mock = new Mock<IStoreRepository>();
            mock.Setup(mock => m.Products).Returns((new ProductControllerTests[] {
            ...
            // Action
            Product[] results = (controller.Index("Cat2", 1).ViewData.Model as ProductsListViewModel).Products.ToArray();
        ...
        public void Generate_Category_Specific_Product_Count() {
            // Arrange
            Mock<IStoreRepository> mock = new Mock<IStoreRepository>();
            mock.Steup(m => m.Products).Returns((new Product[] {
                new Product {ProductID = 1, Name = "P1", Category = "Cat1"},
            ...
            HomeController target = newHomeController(mock.Object);
            target.PageSize = 3;
